...
const features = [
  ...
  },
  {
    ...
    href: "/docs/collectors#temperature",
  },
  {
    icon: "list-tree",
  ...
  <Base>
    ...
    <section class="hero-bg min-h-[85vh] flex flex-col items-center justify-center px-6 py-20">
      ...
      <p class="text-muted text-sm md:text-base max-w-xl text-center mb-10">
        Real-time TUI dashboard with historical charts, hardware monitoring,
        interactive SQL REPL, and alerting.
      </p>
      <InstallCommand />
    </section>
    ...
    <section class="max-w-6xl mx-auto px-6 py-20">
      <h2 class="font-mono font-bold text-xl text-purple glow-purple mb-4 text-center">
        Server monitoring for people who aren't running fleets.
      </h2>
      <p class="text-muted text-base md:text-lg max-w-2xl mx-auto text-center mb-2 leading-relaxed">
        From Raspberry Pis to cobbled-together racks, hobbyists and developers
        run a diverse collection of servers for fun and sometimes profit.
      </p>
      <p class="text-muted text-base md:text-lg max-w-2xl mx-auto text-center mb-2 leading-relaxed">
        bewitch is designed for people who want monitoring without the overhead
        of enterprise tools or cloud services.
      </p>
      <p class="text-muted text-base md:text-lg max-w-2xl mx-auto text-center mb-10 leading-relaxed">
        Whether you're tracking a home media server, a personal website, or a
        cluster of machines in your basement, bewitch is a fun way to keep an
        eye on your hardware.
      </p>
    ...
    <section class="max-w-6xl mx-auto px-6 py-16">
      ...
      <div
        class="glow-box rounded-lg overflow-hidden border border-deep-purple/50"
        id="demo-terminal"
      >
        <div
          class="flex items-center gap-0 font-mono text-xs border-b border-deep-purple/30 overflow-x-auto"
          id="demo-tab-overlay"
        >
          {[
            "Dashboard",
        ...
        <div
          id="demo-terminal-mount"
          class="demo-terminal-mount"
          style="display:none"
        ></div>
        ...
        <div class="text-center text-dim text-xs py-2 font-mono">
          Press 1–8 to switch views · &lt;/&gt; change time range · Tab cycles
          hardware sections
        </div>
      </div>
    </section>
    ...
    <section class="max-w-5xl mx-auto px-6 py-16 space-y-16">
      ...
      <div class="flex flex-col lg:flex-row items-start gap-8">
        <div class="lg:w-1/3">
          <h3 class="font-mono font-semibold text-lg text-pink mb-2">
            Your metrics in SQL
          </h3>
        ...
        <div class="lg:w-2/3 w-full">
          <TerminalBlock title="bewitch repl">
            ...
            <div class="mt-2 text-dim"> mount | pct{"\n"}</div>
            <div class="text-dim">-------+------</div>
            <div class="text-text">
              {" "}
              /{"     "}| 62.34{"\n"}
            </div>
            <div class="text-text"> /home | 41.17</div>
      ...
      <div class="flex flex-col lg:flex-row-reverse items-start gap-8">
        <div class="lg:w-1/3">
          ...
          <p class="text-muted text-sm leading-relaxed">
            Route alerts via email (local mail command or SMTP) or arbitrary
            shell commands. All config-driven, no code required.
          </p>
        </div>
        <div class="lg:w-2/3 w-full">
          <TerminalBlock title="bewitch.toml">
            <div>
              <span class="text-dim">[[alerts.email]]</span>
            </div>
            <div>
              <span class="text-lavender">use_mail_cmd</span>{" "}
              <span class="text-dim">=</span>{" "}
              <span class="text-pink">true</span>
            </div>
            <div>
              <span class="text-lavender">to</span>{" "}
              <span class="text-dim">=</span>{" "}
              <span class="text-pink">["ops@example.com"]</span>
            </div>
            <div class="mt-2">
              <span class="text-dim">[[alerts.commands]]</span>
            </div>
            <div>
              <span class="text-lavender">cmd</span>{" "}
              <span class="text-dim">=</span>{" "}
              <span class="text-pink">"/usr/local/bin/my-handler"</span>
            </div>
          </TerminalBlock>
        </div>
      </div>
      ...
      <div class="flex flex-col lg:flex-row items-start gap-8">
        <div class="lg:w-1/3">
          ...
          <p class="text-muted text-sm leading-relaxed">
            Connect to remote daemons over TLS with auto-generated certificates
            and SSH-like fingerprint pinning. No CA infrastructure needed.
          </p>
        </div>
        <div class="lg:w-2/3 w-full">
          <TerminalBlock title="terminal">
            <div>
              <span class="text-purple">$</span>{" "}
              <span class="text-text">bewitch -addr myserver:9119</span>
            </div>
